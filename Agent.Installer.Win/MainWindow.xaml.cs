...
using Tess.Agent.Installer.Win.ViewModels;
using System;
using System.Windows;
using System.Windows.Documents;
using System.Windows.Input;

namespace Tess.Agent.Installer.Win
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            MessageBox.Show(
                "This is the URL of the Tess server that you're hosting.  The device will connect to this URL.", 
                "Server URL", 
                MessageBoxButton.OK, 
        ...
        {
            MessageBox.Show(
                "This is your organization ID on the Tess server.  Since Tess supports multi-tenancy, " +
